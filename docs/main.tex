...
\begin{figure}
   \subfloat[][Dataset covtype]{\includegraphics[width=0.32\linewidth]{plots/figs/covtype_logistic_l2.eps}}
   \subfloat[][Dataset epsilon]{\includegraphics[width=0.32\linewidth]{plots/figs/epsilon_logistic_l2.eps}}
   \subfloat[][Dataset webspam]{\includegraphics[width=0.32\linewidth]{plots/figs/webspam_logistic_l2.eps}} \\
   \subfloat[][Dataset ckn\_mnist]{\includegraphics[width=0.32\linewidth]{plots/figs/ckn_mnist_logistic_l2.eps}}
   \subfloat[][Dataset svhn]{\includegraphics[width=0.32\linewidth]{plots/figs/svhn_logistic_l2.eps}}
...
\begin{figure}
   \subfloat[][Dataset alpha]{\includegraphics[width=0.32\linewidth]{plots/figs/alpha_logistic_l2.eps}}
   \subfloat[][Dataset rcv1]{\includegraphics[width=0.32\linewidth]{plots/figs/rcv1_logistic_l2.eps}}
   \subfloat[][Dataset real-sim]{\includegraphics[width=0.32\linewidth]{plots/figs/real-sim_logistic_l2.eps}} \\
   \subfloat[][Dataset ocr]{\includegraphics[width=0.32\linewidth]{plots/figs/ocr_logistic_l2.eps}}
   \subfloat[][Dataset kddb]{\includegraphics[width=0.32\linewidth]{plots/figs/kddb_logistic_l2.eps}}
   \subfloat[][Dataset criteo]{\includegraphics[width=0.32\linewidth]{plots/figs/criteo_logistic_l2.eps}}
