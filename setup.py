...
setup(name='cyanure',
      ...
      install_requires=["scipy<=1.8.1;python_version<'3.11'", "scipy>=1.8.1;python_version>='3.11'", "numpy>=1.23.5;python_version>='3.11'", "numpy<=1.23.5;python_version<'3.11'", "scikit-learn<=0.24.2;python_version<'3.8'", "scikit-learn==1.0.2;python_version>='3.8';python_version<'3.11'", "scikit-learn==1.1.3;python_version>='3.11'"],
