...
setup(name='cyanure',
      ...
      install_requires=["scipy<=1.8.1;python_version<'3.10'", "scipy>=1.8.1;python_version>='3.11'", "numpy>=1.23.5;python_version>='3.11'", "numpy>=1.21.5;python_version<'3.11'",'scikit-learn'],
